...
2. Особенности человеческой зрительной системы и их реализация в системах технического зрения
3. Способы регистрации изображения системами технического зрения
4. Цветные сенсоры
5. Динамический диапазон
6. Гамма-преобразование
7. Получение изображения в стандартном цветовом пространстве. Простейший информационный тракт
9. Гиперспектральные изображения. Синтезирование цвета
10. Цветовые профили устройств
...
Проблемы ПЗС: растекание заряда (у старых матриц яркие пиксели передавали свой заряд соседям, вызывая засветку), построчное считывание, требующее времени (вызывает искажения у движущихся объектов).
<div align="center">
