...
## Лекция 2. Системы технического зрения и информационные тракты регистрации изображений
...
Основной принцип регистрации электромагнитного излучения в СТЗ и в естественных зрительных системах не отличается: чем больше излучения попало на чувствительный элемент, тем выше должен быть сигнал. Явление взаимодействия света с веществом, при котором энергия фотонов передаётся электронам вещества называется фотоэффектом. Его изучением занималичь на протияжении догого времени различные ученые, в том числе Герц, Столетов, Эйнштейн (Нобелевкую премию он получил именно за объяснение фотоэффекта).
...
<div align="center">
  ...
  Рисунок 2.4 – Проблема растекания заряда в ПЗС-матрице
</div>
...
<div align="center">
  ...
  Рисунок 2.5 – Проблема построчного переноса информации (rolling shutter)
</div>
...
<div align="center">
  ...
  Рисунок 4.1 – HDR-фото, синтезированное из нескольких фотографий и упакованное в стандартный RGB
</div>
...
<div align="center">
  ...
  Рисунок 4.2 – Пример фото одного объекта, снятое в двух режимах: обычном и HDR
</div>
...
<div align="center">
  ...
  Рисунок 4.3 – Недостаточный динамический диапазон для съемки на улице
</div>

## 2.5 Гамма преобразование

Еще одной проблемой связанной с динамическим диапазоном является необходимость максимизировать количество деталей в наиболее информативной области освещенности. Наши глаза видят иначе, чем камеры. В цифровой камере удвоенное количество фотонов, попадающих на сенсор, означает удвоение сигнала (зависимость «линейна»). Однако наши глаза устроены иначе. Для нас увеличение освещённости вдвое означает, что свет стал слегка ярче (зависимость «нелинейна»). Кстати, линейным RGB называется именно изображение без гамма-коррекции. Коррекция практически однозначна, поэтому переход од линейного к нелинейному варианту не вызывает трудностей.
...
<div align="center">
  ...
  Рисунок 5.2 – Фото без гамма-кодирования и с гамма-кодированием
</div>
...
<div align="center">
  ...
  Рисунок 5.3 – Фото закодированное в log-кривой
</div>
...
<div align="center">
  ...
  Рисунок 7.1 – Разница в глубине цвета (синтезированный пример)
</div>
